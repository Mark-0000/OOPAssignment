 ...
 * @author Lieutenant
 */
public class facPayment extends javax.swing.JFrame {
    ...
    private void btnPayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPayActionPerformed
        ...
        String myDate = date;
        int usernameID = Integer.parseInt(txtStudentID.getText());
    ...
    private void btnDisplayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDisplayActionPerformed
        ...
        String SQL_SELECT = "SELECT * FROM Payment";
        try (Connection conn = DriverManager.getConnection(
                "jdbc:mysql://localhost/21609oopassignment?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "root");
                PreparedStatement preparedStatement = conn.prepareStatement(SQL_SELECT)) {
            ResultSet resultSet = preparedStatement.executeQuery();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        String SQL_SELECT = "SELECT * FROM Payment where StudentID=?";
        int usernameID = Integer.parseInt(txtStudentID.getText());
        try (Connection conn = DriverManager.getConnection(
                "jdbc:mysql://localhost/21609oopassignment?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "root");
                PreparedStatement preparedStatement = conn.prepareStatement(SQL_SELECT)) {
